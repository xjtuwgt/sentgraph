from sent_graph_mhqa.sent_graph_dataloader import HotpotDataset
from os.path import join
from envs import DATASET_FOLDER
from sent_graph_mhqa.sent_graph_dump_features import get_cached_filename
...
class DataHelper:
    ...
    def get_example_file(self, tag, f_type=None):
        cached_filename = get_cached_filename('{}_graph_hotpotqa_tokenized_examples'.format(f_type), self.config)
